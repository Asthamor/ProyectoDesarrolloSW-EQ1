...
public class GrupoJpaController implements Serializable {
  ...
  public List<Grupo> findGrupoByMaestro(int idMaestro) {
    EntityManager em = getEntityManager();
    List<Grupo> group;

    Query q = em.createNamedQuery("Grupo.findByMaestroidMaestro");
    
    
    return q.setParameter("maestroidMaestro", idMaestro).getResultList();
