...
-- -----------------------------------------------------
-- Table `aredespacio`.`publicidadx`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `aredespacio`.`publicidadx` ;

CREATE TABLE IF NOT EXISTS `aredespacio`.`publicidadx` (
